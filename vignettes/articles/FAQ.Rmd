...
No! createSCEobject() can take as input the output of the same function, avoiding doing steps like logcounts calculation, dimensionality reductions, etc. again.
